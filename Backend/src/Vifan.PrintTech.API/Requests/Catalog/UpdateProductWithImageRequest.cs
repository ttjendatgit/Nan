...
/// <summary>
/// Multipart/form-data request for updating a product with an optional image replacement.
...
public class UpdateProductWithImageRequest
{
    ...
    /// <summary>Whether the product is publicly visible.</summary>
    public bool IsActive { get; set; }

    /// <summary>
    /// Optional replacement image file (folder: <c>products</c>).
